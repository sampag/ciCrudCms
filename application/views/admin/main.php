	...
	<div class="col-sm-3">
		<div class="tile-progress tile-light">
			<div class="tile-footer">
				<div class="media">
				<div class="media-left">
				<a href="<?php echo base_url('admin/category'); ?>" class="dash-ico">
					<i class="fa fa-folder-open-o" aria-hidden="true"></i>
				</a>
				</div>
				<div class="media-body">
				<h4 class="media-heading">
					<span class="timer" data-from="0" data-to="{cat_count}" data-speed="1000" data-refresh-interval="50"></span> {cat_meter}
				</h4>
				so far in our blog and our website
				</div>
				</div>
	...
	<div class="col-sm-3">
		<div class="tile-progress tile-light">
			<div class="tile-footer">
				<div class="media">
				<div class="media-left">
				<a href="<?php echo base_url('admin/tag'); ?>" class="dash-ico">
					<i class="fa fa-tags" aria-hidden="true"></i>
				</a>
				</div>
				<div class="media-body">
				<h4 class="media-heading">
					<span class="timer" data-from="0" data-to="{tag_count}" data-speed="1000" data-refresh-interval="50"></span> {tag_meter}
				</h4>
				so far in our blog and our website
				</div>
				</div>
		...
		<div class="tile-progress tile-light">
			<div class="tile-footer">
				<div class="media">
				<div class="media-left">
				<a href="<?php echo base_url('admin/comment'); ?>" class="dash-ico">
				...
				<tbody>
					...
					<tr>
						<td>
							...
							<div class="po-markup">
								<?php 
									echo anchor('admin/post-edit/'.$recent_post->post_random_id, $title_string, array('class' => 'po-link')); 
								?>
						...
						<td class="list-tag">
							<?php 
								if($recent_post->post_category_id == 0){
									...
									echo anchor('admin/post-category/'. $recent_post->category_slug, $recent_post->category_name, array('class'=>'post-list'));
								}
							?>
						</td>
...
{javascript}
<script type="text/javascript" src="<?php echo base_url('assets/libs/count-to/jquery.countTo.js'); ?>"></script>
