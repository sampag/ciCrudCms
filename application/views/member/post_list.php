...
$add_new = anchor('member/post', '<i class="fa fa-plus-circle" aria-hidden="true"></i> Add new', array('class' => 'btn btn-flat-success'));
?>
{header}
<br>
<div class="row">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center">
							<?php echo anchor('member/post-delete/'.$row->post_id.'/'.$row->post_featured_img, '<i class="fa fa-fw fa-trash"></i>', array('class'=>'po-link', 'title' => 'Delete')); ?>
						</td>
					</tr>
					<?php endforeach; }  ?>
					 <?php
