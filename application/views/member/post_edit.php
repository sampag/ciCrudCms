		...
		<div class="col-md-3">
			...
			<div class="form-group">
				...
				<div class="fileinput fileinput-exists" data-provides="fileinput">
					  <div class="fileinput-new thumbnail" style="width: 100%; max-height: 150px;">
					    <img data-src="holder.js/100%x100%" alt="....">
					  </div>
					  <div class="fileinput-preview fileinput-exists thumbnail" style="min-width: 100%; max-height: 250px;">
					  	<?php 
					  		if($featured_img){
					  			echo img($featured_img, 'qwe',array('class' => 'img-responsive', 'alt' => $post_title));
					  		}else{
					  			echo img($featured_img, 'qwe',array('class' => 'img-responsive'));
					  		}
					  	?>
