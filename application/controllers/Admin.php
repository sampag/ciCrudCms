...
class Admin extends CI_Controller{
	...
	{	
		...
		$data = array(
			...
			'recent_posts' => $this->post_model->recentPost(),
			'tag_count' => $this->post_model->meterTag(),
			'tag_meter' => $tag_meter,
			'cat_count' => $this->post_model->meterCategory(),
			'cat_meter' => $category_meter,
			'post_count' => $this->post_model->meterPost(),
			'post_meter' => $post_meter,
			'comment_count' => $this->post_model->meterComment(),
